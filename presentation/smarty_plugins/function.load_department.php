...
class Department
{
	...
	public function __construct()
	{
		...
		// If CategoryID is in the query string we save it (casting it to integer tp protect against invalid values)
	...
	public function init()
	{
		...
		if (isset($this->_mCategoryId)) {
			...
			$this->mNameLabel		= $this->mNameLabel . ' &raquo; ' . $details['name'];
			$this->mDescriptionLabel	= $details['description'];
		}
	}
