<?php
/*
 * Smarty plugin function that gets called when the load_admin_departments function plugin is loaded from a template
 */
...
class AdminDepartments
{
	...
	public function init()
	{
		...
		// If upgrading an existing department ...
		...
		if ($this->mAction == 'edit_categ') {
			header('Location: admin.php?Page=Categories&DepartmentID=' . $this->mActionedDepartmentId);
			exit;
		}
