...
<div id="admin_login_box">
	...
	<br /><br />
	<span class="admin_page_text">Enter login information or go back to <a href="{"index.php"|prepare_link:"http"}">storefront</a></span>
	<br />
	...
	<form method="post" action="{"admin.php"|prepare_link:"https"}">
		Username: <input type="text" name="username" value="{$admin_login->mUsername}" />&nbsp;&nbsp;Password: <input type="password" name="password" value="" />
		<br /><br />
