...
<p class="first_page_text">
	We hope you have fun developing HatShop, the e-commerce store from
	<br />
...
<br />
<p class="description">This week we have discounted prices for these fantastic products!</p>
