...
class ErrorHandler
{
	...
	{
		return set_error_handler(['ErrorHandler','Handler'], $errTypes);
	}
	...
	public static function Handler($errNo, $errStr, $errFile, $errLine)
	{
		 ...
		 */
		if (($errNo == E_WARNING && IS_WARNING_FATAL == FALSE) || ($errNo == E_NOTICE || $errNo == E_USER_NOTICE)) { // If the error is nonfatal ...
			// Show message only if DEBUGGING is true
			if (DEBUGGING == TRUE)
				echo '<pre>' , $erro_message , '</pre>';
